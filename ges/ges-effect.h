...
void
ges_effect_class_register_rate_property (GESEffectClass *klass, const gchar *property_name);

void
ges_effect_class_register_rate_property_by_element (GESEffectClass *klass, const gchar *element, const gchar *property_name);
